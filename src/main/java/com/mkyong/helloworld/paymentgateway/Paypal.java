...
//        System.out.println( "test " +config.getProperty("clientID"));
//        System.out.println( config.getProperty("clientSecret"));
//        System.out.println( map);
//        System.out.println( config.getProperty("service.EndPoint"));
        try {
    ...
    public Transaction processPayment(Transaction transaction) throws Exception {
        ...
        if (transaction.getCreditCard().getUUID() != null) {
            ...
            creditCard.setCvv2(new Integer(transaction.getCreditCard().getCvv()));
...
//        amount.setDetails(details);
        ...
        System.out.println("process payment " + transaction.getDescription());
        ...
        try {
            ...
            APIContext apiContext = new APIContext(accessToken);
            System.out.println(" process payment " + apiContext);
